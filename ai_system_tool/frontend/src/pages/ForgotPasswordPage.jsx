    ...
    <div className="relative min-h-screen bg-[#f8fafc] flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className={`w-full max-w-md transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-semibold text-[#0f172a]">Reset password</h2>
        ...
        <div className="relative">
          ...
          {sent ? (
            <div className="relative bg-[#ffffff]/90 backdrop-blur-xl border border-[#f1f5f9] rounded-2xl p-8 text-center shadow-xl shadow-black/20">
              ...
              <h3 className="text-[#0f172a] font-semibold text-lg mb-2">Check your email</h3>
              <p className="text-[#475569] text-sm leading-relaxed">
                If an account exists for <span className="text-[#334155] font-medium">{email}</span>,
            ...
            <form onSubmit={handleSubmit} className="relative bg-[#ffffff]/90 backdrop-blur-xl border border-[#f1f5f9] rounded-2xl p-6 md:p-8 space-y-5 shadow-xl shadow-black/20">
              ...
              <Link
                to="/login"
                className="flex items-center justify-center gap-2 text-sm text-[#64748b] hover:text-[#475569] transition-colors"
              >
                <ArrowLeft size={16} />
                Back to sign in
              </Link>
